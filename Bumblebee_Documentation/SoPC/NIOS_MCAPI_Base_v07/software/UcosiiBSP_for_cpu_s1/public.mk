...
JDI_FILE := F:/Projekte/MCAPIforDE1-Soc/MCAPI_DE1-SoC_SoCs/NIOS_MCAPI_Base_v01/soc_system.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := F:/Projekte/MCAPIforDE1-Soc/MCAPI_DE1-SoC_SoCs/NIOS_MCAPI_Base_v01/soc_system.sopcinfo
...
# setting hal.stderr is jtag_uart_cpu_s1
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_cpu_s1

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_cpu_s1
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_cpu_s1
...
# setting hal.stdout is jtag_uart_cpu_s1
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_cpu_s1
