 ...
 * V1.301, May 2010
 * Edition History:
 * 2014-05-23: MCAPI_ERR_CHAN_NCNO added - ms
*/
...
enum mcapi_status_codes {
	MCAPI_SUCCESS = 1,				// 1: Indicates operation was successful
  ...
  MCAPI_ERR_ENDP_LIMIT,
	...
	MCAPI_ERR_GENERAL,
	MCAPI_ERR_CHAN_NCNO,			// Channel is not connected (NC) or not open (NO)
